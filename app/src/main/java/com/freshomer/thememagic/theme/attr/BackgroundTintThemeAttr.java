...
public class BackgroundTintThemeAttr extends ThemeAttr{
    ...
    public void apply(View view, Theme theme) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            view.setBackgroundTintList(resources.getColorStateList(resourceId));
        }
    }

    public static BackgroundTintThemeAttr createThemeAttr(TypedValue typedValue) {
        if(typedValue.resourceId != 0 &&
            ...
            return new BackgroundTintThemeAttr(typedValue.resourceId);
        }

        return null;
    }

    BackgroundTintThemeAttr(int resourceId) {
        super(android.R.attr.backgroundTint, resourceId);
    }
